...
import type {PostDocument} from './post-document';
export interface PublishRequest { text: string; post_document?: PostDocument; targets: Platform[]; metadata?: Metadata; post_id?: number; idempotency_key: string }
