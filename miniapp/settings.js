...
const botUi=addAction(botValue,'edit-personal-bot','Настроить Личный чат'),groupUi=addAction(groupValue,'edit-tg-group','Добавить или сменить Telegram-группу'),vkUi=addEdit($('#settings-vk-group-value'),'edit-vk-group','Добавить или сменить группу ВКонтакте');
