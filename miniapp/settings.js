...
function setAction(ui,label,{hidden=false}={}){if(!ui.button)return;ui.button.hidden=hidden;ui.button.textContent=label;ui.button.classList.toggle('settings-text-action',true);ui.button.removeAttribute('aria-label')}
