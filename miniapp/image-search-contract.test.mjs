...
test('product review transfers explicit official-image search options to Composer',()=>{
  assert.match(responseUi,/'Разбор препарата'[\s\S]*internetSearch:\s*true[\s\S]*searchProfile:\s*'cosmetic_product'[\s\S]*sourcePolicy:\s*'official'/);
