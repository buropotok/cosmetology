(()=>{
  ...
  style.textContent=`
  .new-post-entry{margin:16px;padding:18px;border-radius:18px;background:#fff;box-shadow:0 8px 30px rgba(0,0,0,.08);color:#1c1c1e}
  .new-post-entry[hidden]{display:none!important}
  .new-post-entry__title{margin:0 0 6px;font:700 22px/1.25 -apple-system,BlinkMacSystemFont,"SF Pro Text","Segoe UI",sans-serif}
  .new-post-entry__subtitle{margin:0 0 18px;color:#8e8e93;font:14px/1.4 -apple-system,BlinkMacSystemFont,"SF Pro Text","Segoe UI",sans-serif}
  .new-post-entry__actions{display:grid;gap:10px}
  .new-post-entry__button{width:100%;min-height:56px;display:flex;align-items:center;justify-content:flex-start;gap:12px;border:0;border-radius:13px;padding:13px 16px;background:#2d8fd3;color:#fff;font:700 16px/1.25 -apple-system,BlinkMacSystemFont,"SF Pro Text","Segoe UI",sans-serif;text-align:left}
  .new-post-entry__button img{width:24px;height:24px;display:block;flex:0 0 24px}
  .new-post-entry__button--manual img{width:23px;height:23px}
  .new-post-entry__button--before-after{background:#fff;color:#2d8fd3;border:1px solid rgba(45,143,211,.28)}
  .new-post-entry__pair{width:28px;display:flex;align-items:center;gap:1px;flex:0 0 28px}
  .new-post-entry__pair img{width:17px;height:17px}
  @media(max-width:520px){.new-post-entry{margin:12px;padding:15px}.new-post-entry__button{min-height:54px;padding:12px 14px}}
  `;
  ...
  entry.innerHTML=`<h2 class="new-post-entry__title">Новый пост</h2><p class="new-post-entry__subtitle">Выберите способ создания публикации</p><div class="new-post-entry__actions"><button type="button" class="new-post-entry__button" data-new-post-choice="ai"><img src="/assets/icons/cosmo-sofa.svg" alt="" aria-hidden="true"><span>Создать пост с помощью AI</span></button><button type="button" class="new-post-entry__button new-post-entry__button--manual" data-new-post-choice="manual"><img src="/assets/icons/manual-edit.svg" alt="" aria-hidden="true"><span>Создать пост вручную с нуля</span></button><button type="button" class="new-post-entry__button new-post-entry__button--before-after" data-new-post-choice="before-after"><span class="new-post-entry__pair" aria-hidden="true"><img src="/assets/icons/account-box.svg" alt=""><img src="/assets/icons/account-box.svg" alt=""></span><span>ДО / ПОСЛЕ</span></button></div>`;
