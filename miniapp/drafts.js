(()=>{
const tg=window.Telegram?.WebApp,text=document.querySelector('#text'),imageInput=document.querySelector('#image'),previews=document.querySelector('#previews');
