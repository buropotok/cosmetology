(()=>{
const tg=window.Telegram?.WebApp,state=window.CosmoComposerState;
...
const store=window.CosmoDraftStoreFactory.create({state,fetchImpl,authHeaders:()=>({Authorization:`tma ${tg.initData}`}),log});
