...
(()=>{
  ...
  style.textContent=`
    ...
    .composer-emoji-panel{position:fixed;z-index:140;display:flex;flex-wrap:wrap;gap:4px;width:220px;padding:8px;background:#fff;border:1px solid #ddd;border-radius:12px;box-shadow:0 8px 30px #0002;touch-action:none}
    .composer-emoji-drag-handle{flex:0 0 100%;height:18px;margin:-4px 0 2px;cursor:grab;touch-action:none;position:relative}
