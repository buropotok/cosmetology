(()=>{
  ...
  function destroySolo(){if(!overlay)return;frameBridge()?.destroySoloSession?.();overlay.remove();overlay=null;soloIndex=null;soloFile=null;currentMode='dual'}
  ...
  function clear(){if(!overlay)return;frameBridge()?.destroySoloSession?.();overlay.remove();overlay=null;soloIndex=null;soloFile=null;currentMode='dual';document.documentElement.style.overflow=''}
