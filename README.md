...
- `POST /api/miniapp/debug/managed-bot/create-link` и обработка `managed_bot` webhook — изолированный Managed Bots PoC без хранения bot token и без изменения текущего publisher flow.
