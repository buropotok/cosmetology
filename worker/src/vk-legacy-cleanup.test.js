...
describe('removed VK test shell',()=>{
  it('does not expose the obsolete Cloudflare VK test runtime',()=>{
    ...
    expect(existsSync(resolve(repositoryRoot,'worker/src/vk-miniapp.ts'))).toBe(false);
  });
});
