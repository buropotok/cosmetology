...
const intent=(action:'telegram_preview'|'telegram_publish'|'publish_vk',waiting_for='telegram_bot')=>({user_id:'usr_1',action,draft_ref:null,return_screen:'composer',waiting_for,status:'pending',created_at:'2026-09-05 00:00:00',updated_at:'2026-09-05 00:00:00',expires_at:'2026-09-06 00:00:00'} as any);
...
describe('onboarding action intent reconciler',()=>{
  it.each([
    ...
    ['VK publish awaiting VPN confirmation','publish_vk',{botReady:false,previewReady:false,groupReady:false},'show_vk_vpn_confirmation','vk_vpn'],
