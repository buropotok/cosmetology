...
describe('explicit composer actions',()=>{
  ...
  it('loads the action module exactly once through the New Post runtime',()=>{const runtime=source('new-post-runtime.js');expect(runtime.match(/composer-actions\.js/g)).toHaveLength(1);expect(runtime.indexOf('drafts.js')).toBeLessThan(runtime.indexOf('composer-actions.js'))});
});
